            ...
            <?php if(isset($tinNoiBat)): ?>
                <div class="highlight">
                    ...
                    <div class="caption">
                        ...
                        <p class="mb-0"><?php echo e(\Carbon\Carbon::parse($tinNoiBat->created_at)->diffForHumans()); ?></p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="row">
                <?php $__currentLoopData = $tatCaTin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-12 col-md-6">
                        <div class="news-card">
                            <img src="<?php echo e(Str::startsWith($tin->image, ['http://', 'https://']) ? $tin->image : asset('storage/' . $tin->image)); ?>" alt="Ảnh tin">
                            <div class="card-body">
                                <div class="category">
                                ...
                                <h5 class="card-title">
                                    <a href="<?php echo e(route('tin', $tin->id)); ?>" class="text-dark text-decoration-none">
                                        <?php echo e($tin->title); ?>

                                    </a>
                                </h5>
                                <p class="card-text"><?php echo e(\Carbon\Carbon::parse($tin->created_at)->diffForHumans()); ?></p>
                                <a href="<?php echo e(route('tin', $tin->id)); ?>" class="btn btn-sm btn-outline-success mt-2">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\php31\ASM2\resources\views/home.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>" id="pass" name="password" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if(!auth()->check()): ?>
            <p class="text-center mt-3">Đã có tài khoản? <a href="<?php echo e(route('login')); ?>">Đăng nhập</a></p>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\PHP3\ASM1\resources\views/auth/register.blade.php ENDPATH**/ ?>
...
<div class="admin-wrapper">
    ...
    <div class="main-content">
        ...
        <form action="<?php echo e(route('admin.news.update', $news->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $news->title)); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="5"><?php echo e(old('content', $news->content)); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\php31\ASM2\resources\views/admin/news_edit.blade.php ENDPATH**/ ?>
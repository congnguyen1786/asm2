<header class="navbar navbar-expand-lg navbar-dark custom-navbar">
    <div class="container">
        <a class="navbar-brand glow-text" href="{{ route('home') }}">tintuc23h</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link fancy-hover" href="{{ route('contact') }}">✉️ Liên hệ</a></li>
                ...
                @auth
                    ...
                    <li class="nav-item">
                        <a class="nav-link fancy-hover">🙋 {{ Auth::user()->name }}</a>
                    </li>
